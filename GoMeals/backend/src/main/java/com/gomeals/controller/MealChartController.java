...
/**
 * This controller contains the methods that is used to handle the meal chart of a
 * particular supplier
 */
public class MealChartController {
    ...
    /**
     * This method is used to update the existing meal chart of a particular supplier
     * @param mealChart
    ...
    /**
     * This method is used to delete the particular entries in meal chart table hence deleting the meal chart
     * @param id
